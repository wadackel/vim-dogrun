...
pub fn get_highlights() -> Vec<Highlight> {
    return vec![
        ...
        hi!("NvimTreeGitMerge", yellow, -, -, None, -),
        hi!("NvimTreeGitRenamed", yellow, -, -, None, -),
        hi!("NvimTreeGitNew", teal, -, -, None, -),
        hi!("NvimTreeGitDeleted", difftextbg, -, -, None, -),
        ...
        hi!("NvimTreeBookmark", yellow, -, -, None, -),
        // fern.vim
